...
public class SoundStopMechanic extends SkillMechanic implements ITargetedEntitySkill {
    private final PlaceholderString sound;

    public SoundStopMechanic(CustomMechanic holder, MythicLineConfig mlc) {
