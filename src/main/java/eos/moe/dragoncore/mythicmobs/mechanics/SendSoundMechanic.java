...
public class SendSoundMechanic extends SkillMechanic implements ITargetedEntitySkill {
    ...
    public SendSoundMechanic(CustomMechanic holder, MythicLineConfig mlc) {
